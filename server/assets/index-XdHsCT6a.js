import { r as reactExports, T as jsxRuntimeExports } from "./worker-entry-DUTXB3bJ.js";
import "node:events";
...
function NeuralHexagon({ onAssembled }) {
  const canvasRef = reactExports.useRef(null);
  const [assembled, setAssembled] = reactExports.useState(false);
  const assembledRef = reactExports.useRef(false);
  const startTimeRef = reactExports.useRef(0);
  const ASSEMBLY_DELAY = 250;
  const ASSEMBLY_DURATION = 2200;
  reactExports.useEffect(() => {
    ...
    const PARTICLE_COUNT = window.innerWidth < 640 ? 102 : 120;
    ...
    let raf = 0;
    const render = (time2) => {
      if (!startTimeRef.current) startTimeRef.current = time2;
      const elapsed = time2 - startTimeRef.current;
      let progress2 = 0;
      if (elapsed > ASSEMBLY_DELAY) {
        progress2 = Math.min(1, (elapsed - ASSEMBLY_DELAY) / ASSEMBLY_DURATION);
      }
      const eased = smoothstep(progress2);
      ...
      particles.forEach((p) => {
        if (!capturedStart) {
          p.vx += Math.sin(t * 0.6 + p.phase) * 0.012 + (Math.random() - 0.5) * 8e-3;
          p.vy += Math.cos(t * 0.5 + p.phase * 1.3) * 0.012 + (Math.random() - 0.5) * 8e-3;
          p.vx *= 0.985;
          p.vy *= 0.985;
          ...
          const px2 = -dy / len;
          const py = dx / len;
          const swell = Math.sin(Math.PI * progress2) * (1 - eased * 0.85);
          const wave = Math.sin(progress2 * Math.PI * p.freq * 2 + p.phase) * p.amp * swell;
          p.x = baseX + px2 * wave;
          p.y = baseY + py * wave;
        }
      });
      ...
      if (!capturedStart) {
        ...
        const byEdge = Array.from({ length: VERTEX_COUNT }, () => []);
      ...
      ctx.shadowBlur = 0;
      if (!assembledRef.current && progress2 >= 1) {
...
function Index() {
  const [assembled, setAssembled] = reactExports.useState(false);
  const [automation, setAutomation] = reactExports.useState("");
  const handleSendMail = () => {
    const subject = encodeURIComponent("Automation Request — Tandem AI Labs");
    const body = encodeURIComponent(automation.trim() || "Hi Tandem AI Labs,\n\nI'd like to discuss automating the following workflow:\n\n");
    window.location.href = `mailto:${BIZ_EMAIL}?subject=${subject}&body=${body}`;
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative min-h-screen overflow-hidden bg-black text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none fixed inset-0 z-0", style: {
      background: "radial-gradient(ellipse at center, transparent 0%, rgba(0,0,0,0.4) 80%, rgba(0,0,0,0.9) 100%)"
    } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none fixed inset-0 z-[5]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NeuralHexagon, { onAssembled: () => setAssembled(true) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "fixed left-0 right-0 top-0 z-20 flex items-center justify-between px-6 py-6 text-xs uppercase tracking-[0.3em] text-white/70 sm:px-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Tandem" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "est. 2026" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none fixed inset-0 z-10 flex flex-col items-center justify-center text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: assembled ? /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      opacity: 0,
      scale: 0.6,
      filter: "blur(14px)"
    }, animate: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-3xl font-bold tracking-tight text-white sm:text-5xl glow-text whitespace-nowrap", children: "Tandem AI Labs" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.span, { initial: {
        ...
        duration: 0.7,
        ease: [0.22, 1, 0.36, 1]
      }, className: "mt-4 block text-xs font-light tracking-[0.4em] sm:text-sm shimmer-text", children: "COMING SOON" })
    ] }, "brand") : /* @__PURE__ */ jsxRuntimeExports.jsx(motion.h2, { initial: {
      opacity: 0,
      scale: 0.96
    }, animate: {
      opacity: 1,
      ...
      duration: 0.6
    }, className: "text-xl font-light tracking-[0.4em] sm:text-2xl shimmer-text animate-breathe", children: "COMING SOON" }, "pre") }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex min-h-screen flex-col px-6 pb-10 pt-24 sm:px-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.section, { initial: {
        ...
        opacity: assembled ? 1 : 0.3,
        y: assembled ? 0 : 20
      }, transition: {
        duration: 0.8,
        delay: assembled ? 0.4 : 0
      }, className: "mx-auto w-full max-w-3xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-white/30 bg-black/70 p-5 backdrop-blur-md sm:p-7", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs uppercase tracking-[0.3em] text-white/70", children: "Request Automation" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-4 h-px flex-1 bg-white/20" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "automation", className: "mb-2 block text-sm font-medium text-white", children: "What do you want to automate?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 sm:flex-row", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { id: "automation", value: automation, onChange: (e) => setAutomation(e.target.value), placeholder: "Tell us about your manual workflows...", rows: 3, className: "flex-1 resize-none rounded-xl border border-white/30 bg-black px-4 py-3 text-sm text-white placeholder:text-white/40 outline-none transition-all focus:border-white focus:shadow-[0_0_20px_rgba(255,255,255,0.25)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: handleSendMail, className: "group flex items-center justify-center gap-2 self-stretch rounded-xl border border-white bg-white px-5 py-3 text-sm font-semibold uppercase tracking-wider text-black transition-all hover:bg-black hover:text-white hover:shadow-[0_0_25px_rgba(255,255,255,0.6)] sm:self-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "h-4 w-4" }),
              "Send Mail"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid gap-3 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${PH_NUMBER.replace(/\s/g, "")}`, className: "group flex items-center gap-3 rounded-xl border border-white/30 bg-black px-4 py-3 transition-all hover:border-white hover:shadow-[0_0_18px_rgba(255,255,255,0.35)]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 text-white" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-light tracking-wide text-white group-hover:glow-text", children: PH_NUMBER })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `mailto:${BIZ_EMAIL}`, className: "group flex items-center gap-3 rounded-xl border border-white/30 bg-black px-4 py-3 transition-all hover:border-white hover:shadow-[0_0_18px_rgba(255,255,255,0.35)]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 text-white" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-light tracking-wide text-white group-hover:glow-text", children: BIZ_EMAIL })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-center text-[10px] uppercase tracking-[0.3em] text-white/50", children: "© 2026 Tandem AI Labs · All Rights Reserved" })
      ] })
    ] })
  ] });
}
